...
class Game:
    ...
    def _setup_prototypes(self) -> None:
        ...
        warrior = Enemy(enemy_type="Warrior", health=100, speed=50,
                        armored=True, weapon="Sword")
        mage = Enemy(enemy_type="Mage", health=80, speed=70,
                     armored=False, weapon="Staff")
        archer = Enemy(enemy_type="Archer", health=90, speed=80,
                       armored=False, weapon="Bow")
